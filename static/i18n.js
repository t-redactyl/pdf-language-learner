...
const messages = {
  en: {
    ...
    "revision.modeConjugation": "Verb workout",
    "conjugation.title": "Verb workout",
    "conjugation.preparing": "Preparing your verb workout…",
    "conjugation.lemma": "Dictionary form",
    "conjugation.form": "Target form",
    "conjugation.person": "Person",
    "conjugation.instruction": "Type the complete verb form",
    "conjugation.requiredCase": "Required case",
    "conjugation.prepositionInstruction": "Type the missing preposition",
    "conjugation.correct": "Correct",
    "conjugation.incorrect": "Not quite — add this form to the retry round.",
    "conjugation.progress": "Form {current} of {total}",
    "conjugation.loadError": "The verb workout could not be loaded",
    "grammar.title": "Grammar revision",
    "grammar.generating": "Generating the next grammar exercise…",
    "grammar.checking": "Checking your answer…",
    "grammar.loadingNext": "Loading…",
    "grammar.requestTimeout": "The grammar request took too long. Please try again.",
    "grammar.loadError": "Grammar revision could not be loaded",
    "grammar.kind.lesson": "New topic",
    "grammar.kind.review": "Review",
    "grammar.kind.mixed": "Review + new topic",
    ...
    "grammar.summaryGenerating": "Generating a brief summary…",
    "grammar.summaryError": "This summary could not be generated. Close and reopen to try again.",
    "grammar.keyPoints": "Key points",
    "grammar.examples": "Examples",
    "grammar.referenceAnswer": "Reference answer",
    "grammar.practiceVerbs": "Practise these verbs",
    "grammar.notQuite": "Not quite",
    "grammar.finish": "Finish",
    "grammar.continueTo.review": "Continue to review",
    "grammar.continueTo.lesson": "Continue to new topic",
    ...
    "revision.hint": "Hint",
    "revision.memoryAid": "Memory aid",
    "revision.mnemonic.acoustic_hook": "Acoustic hook",
    "revision.mnemonic.sound_bridge": "Sound bridge",
    "revision.mnemonic.literal_root_breakdown": "Root breakdown",
    "revision.mnemonic.conceptual_bridge": "Conceptual bridge",
    "revision.mnemonic.role.prefix": "Prefix",
    "revision.mnemonic.role.stem": "Stem",
    "revision.mnemonic.role.compound_part": "Compound part",
    ...
    "reviewReminder.eyebrow": "Ready to practise",
    "reviewReminder.vocabularyTitle": "Vocabulary review",
    "reviewReminder.grammarTitle": "Grammar review",
    "reviewReminder.vocabulary.one": "{count} vocabulary item",
    "reviewReminder.vocabulary.other": "{count} vocabulary items",
    "reviewReminder.grammar.one": "{count} grammar topic",
    "reviewReminder.grammar.other": "{count} grammar topics",
    "reviewReminder.reviewTopic.one": "{count} review topic",
    "reviewReminder.reviewTopic.other": "{count} review topics",
    "reviewReminder.newTopic.one": "{count} new topic",
    "reviewReminder.newTopic.other": "{count} new topics",
    "reviewReminder.nextSession": "{items} in your next session.",
    "reviewReminder.summary": "{items} ready to review.",
    "reviewReminder.vocabularyOpen": "Review vocabulary",
    "reviewReminder.grammarOpen": "Review grammar",
  ...
  es: {
    ...
    "revision.modeConjugation": "Entrenamiento verbal",
    "conjugation.title": "Entrenamiento verbal",
    "conjugation.preparing": "Preparando el entrenamiento verbal…",
    "conjugation.lemma": "Infinitivo",
    "conjugation.form": "Forma verbal",
    "conjugation.person": "Persona",
    "conjugation.instruction": "Escribe la forma verbal completa",
    "conjugation.requiredCase": "Caso requerido",
    "conjugation.prepositionInstruction": "Escribe la preposición que falta",
    "conjugation.correct": "Correcto",
    "conjugation.incorrect": "Casi — esta forma vuelve en la ronda de reintento.",
    "conjugation.progress": "Forma {current} de {total}",
    "conjugation.loadError": "No se pudo cargar el entrenamiento verbal",
    "grammar.title": "Repaso de gramática",
    "grammar.generating": "Generando el siguiente ejercicio de gramática…",
    "grammar.checking": "Comprobando tu respuesta…",
    "grammar.loadingNext": "Cargando…",
    "grammar.requestTimeout": "La solicitud de gramática tardó demasiado. Inténtalo de nuevo.",
    "grammar.loadError": "No se pudo cargar el repaso de gramática",
    "grammar.kind.lesson": "Tema nuevo",
    "grammar.kind.review": "Repaso",
    "grammar.kind.mixed": "Repaso + tema nuevo",
    ...
    "grammar.summaryGenerating": "Generando un resumen breve…",
    "grammar.summaryError": "No se pudo generar este resumen. Ciérralo y vuelve a abrirlo para intentarlo de nuevo.",
    "grammar.keyPoints": "Puntos clave",
    "grammar.examples": "Ejemplos",
    "grammar.referenceAnswer": "Respuesta de referencia",
    "grammar.practiceVerbs": "Practicar estos verbos",
    "grammar.notQuite": "Casi",
    "grammar.finish": "Finalizar",
    "grammar.continueTo.review": "Continuar al repaso",
    "grammar.continueTo.lesson": "Continuar al tema nuevo",
    ...
    "revision.hint": "Pista",
    "revision.memoryAid": "Ayuda para recordar",
    "revision.mnemonic.acoustic_hook": "Gancho acústico",
    "revision.mnemonic.sound_bridge": "Puente sonoro",
    "revision.mnemonic.literal_root_breakdown": "Descomposición de raíces",
    "revision.mnemonic.conceptual_bridge": "Puente conceptual",
    "revision.mnemonic.role.prefix": "Prefijo",
    "revision.mnemonic.role.stem": "Raíz verbal",
    "revision.mnemonic.role.compound_part": "Parte del compuesto",
    ...
    "reviewReminder.eyebrow": "Listo para practicar",
    "reviewReminder.vocabularyTitle": "Repaso de vocabulario",
    "reviewReminder.grammarTitle": "Repaso de gramática",
    "reviewReminder.vocabulary.one": "{count} palabra de vocabulario",
    "reviewReminder.vocabulary.other": "{count} palabras de vocabulario",
    "reviewReminder.grammar.one": "{count} tema de gramática",
    "reviewReminder.grammar.other": "{count} temas de gramática",
    "reviewReminder.reviewTopic.one": "{count} tema de repaso",
    "reviewReminder.reviewTopic.other": "{count} temas de repaso",
    "reviewReminder.newTopic.one": "{count} tema nuevo",
    "reviewReminder.newTopic.other": "{count} temas nuevos",
    "reviewReminder.nextSession": "{items} en tu próxima sesión.",
    "reviewReminder.summary": "{items} para repasar.",
    "reviewReminder.vocabularyOpen": "Repasar vocabulario",
    "reviewReminder.grammarOpen": "Repasar gramática",
