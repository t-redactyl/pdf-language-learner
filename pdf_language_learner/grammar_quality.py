    ...
    return [
        {
            ...
            "content": (
                ...
                "Translation grading sees the full instruction, prompt, reference, and rubric together. "
                ...
                "Translations are graded by an LLM using the rubric and reference, not by exact "
                "matching against accepted_answers. That list is illustrative for translations: "
