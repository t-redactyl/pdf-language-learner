    ...
    return [
        {
            ...
            "content": (
                ...
                "invalid because several different words could fit. Whenever the required form depends "
                "on grammatical person, number, gender, or formality, explicitly state the intended "
                "features in the instruction or prompt. In particular, conjugation tasks must show the "
                "target pronoun (for example, tú, usted, or ustedes) when the sentence itself does not "
                "unambiguously identify it. Explain every grammar rule in "
