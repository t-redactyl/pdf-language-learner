...
ENV PYTHONDONTWRITEBYTECODE=1 \
    ...
    OPENAI_GRAMMAR_MODEL="gpt-5.6-luna" \
    OPENAI_GRAMMAR_TIMEOUT_SECONDS="180" \
    OPENAI_GRAMMAR_MAX_OUTPUT_TOKENS="20000" \
    OPENAI_GRAMMAR_GENERATION_EFFORT="high" \
    OPENAI_GRAMMAR_GRADING_EFFORT="high" \
    GRAMMAR_GENERATION_ENABLED="false" \
    MNEMONIC_AUTOGENERATION_ENABLED="false" \
